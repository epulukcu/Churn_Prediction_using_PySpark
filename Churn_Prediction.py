...
spark_df = spark.read.csv(r"C:\Users\Elif\PycharmProjects\Churn_Pred\churn2.csv", header=True, inferSchema=True)
spark_df
spark_df.show()
...
# Final dataframe with set of features, label variables
final_df = va_df.select('features', 'label')
